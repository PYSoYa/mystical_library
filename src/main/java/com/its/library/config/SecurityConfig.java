...
//        http.csrf().disable();
        http.authorizeRequests()
                ...
                .antMatchers("/member/check-password", "/member/delete/**", "/member/update-form/**", "/member/update").authenticated()
                .antMatchers("/book/episode/**", "/book/findBook").authenticated()
                .antMatchers("/comment/**").authenticated()
//                .antMatchers("/debut/**").authenticated()
                .antMatchers("/debut/save-form", "/debut/update-form/**", "/debut/delete/**").authenticated()
